...
Route::get('/post/{postId}/showComments', 'App\Http\Controllers\PostController@showCommentsInSinglePost')->name('showCommentsInSinglePost');Route::delete('/posts/{postId}/showComments/{commentId}/delete', 'App\Http\Controllers\CommentController@delete')->name('comments.delete');
